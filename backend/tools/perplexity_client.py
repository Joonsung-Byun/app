...
USER_PROMPT_TEMPLATE = (
    ...
    "- 명시 날짜: YYYY-MM-DD, YYYY년 M월 D일, M월 D일 → 올해 기준, 이미 지났으면 내년. M월만 있으면 그 달 전체.\n"
    "- 상대 날짜: 오늘/내일/모레, X일 뒤/후, X주 뒤/후, 이번주/다음주/다다음주, 이번주말/다음주말/다다음주말.\n"
    "- 요일: 이번주/다음주/다다음주의 특정 요일(월~일) 또는 \"금요일\" 등은 가장 가까운 미래 날짜로 계산.\n"
    "- 월/연 단위: 이번달/다음달/다다음달은 해당 달 전체. 연말=올해 12월(지났으면 내년), 연초/신정=1월 1주차.\n"
    "- 기념일 예시: 크리스마스=12월 25일, 크리스마스이브=12월 24일, 할로윈=10월 31일 (이미 지났으면 내년으로).\n"
    "- 예시에 없더라도 모든 상대/절대 날짜 표현을 오늘 기준으로 명확한 구간(start~end)으로 계산해 적용하고, 과거는 제외.\n"
    ...
    "- description에는 날짜(또는 날짜 범위)와 장소를 한 문장으로 요약해.\n"
    "- location에는 지도 검색으로 바로 찾을 수 있는 구체적인 건물/랜드마크/전시장 이름만 넣고, 층/호/룸번호는 넣지 마. (예: 코엑스, 세종문화회관, 부산시민회관)\n"
)
